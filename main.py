...
from bot_modules import profile, start, projects, groups, access, backup, tasks, needs, comments
...
modules = [tasks, access, profile, start, projects, groups, backup, needs, comments]
